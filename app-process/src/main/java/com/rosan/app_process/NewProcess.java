...
public class NewProcess {
    ...
    private static void exitFromOrphanWatchdog() {
        ProcessManager.restorePendingNetwork();
    ...
    private static IBinder createBinder(ComponentName componentName) throws PackageManager.NameNotFoundException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, ClassNotFoundException {
        return createBinder(getUIDContext(), componentName);
    }

    private static IBinder createBinder(Context context, ComponentName componentName) throws PackageManager.NameNotFoundException, ClassNotFoundException {
    ...
    private static List<String> getPackagesForUid(Context context, int uid) {
    ...
    private static Context getUIDContext() throws PackageManager.NameNotFoundException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, IllegalAccessException {
