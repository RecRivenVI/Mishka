...
public abstract class AppProcess implements Closeable {
    ...
    public boolean armNetworkRecovery(int uid, boolean chainWasEnabled) throws RemoteException {
        return requireManager().armNetworkRecovery(uid, chainWasEnabled);
    }

    public boolean clearNetworkRecovery() throws RemoteException {
        return requireManager().clearNetworkRecovery();
    }
