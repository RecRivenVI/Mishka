...
class ProcessHookRecycler(
    ...
    class HookedUserService(
        ...
        fun armNetworkRecovery(uid: Int, chainWasEnabled: Boolean): Boolean =
            appProcessHandle.entity.armNetworkRecovery(uid, chainWasEnabled)

        fun clearNetworkRecovery(): Boolean =
            appProcessHandle.entity.clearNetworkRecovery()
